...
<div class="card">
    <div class="card-body">
        <form id="form" method="POST" action="<?= site_url('master/update/warna') ?>">
            <div class="form-group">
                <label for="nama_warna">Nama Warna</label>
                <input name="nama_warna" type="text" class="form-control" id="nama_warna" aria-describedby="nama_warna" value="<?= $data->nama_warna ?>" autofocus required>
